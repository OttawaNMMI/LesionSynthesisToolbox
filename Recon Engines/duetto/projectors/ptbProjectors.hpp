...
#define SPEED_OF_LIGHT  3e11   /* mm/s */

#define MAX_SLICES_IN_LOR 20
...
struct DDThetaParams {    
    unsigned short tofSkip;
    unsigned int zSkip;
    float dz1;
    float dz2;    
};
typedef struct DDThetaParams DD_PARAMS;
...
void reorderDims4312(int n1, int n2, int n3, int n4, float *pOrig, float *pReorder);
void reorderDims4213(int n1, int n2, int n3, int n4, float *pOrig, float *pReorder);
void permute4312(int n1, int n2, int n3, int n4, float *pOrig, float *pNew);
void permute4213(int n1, int n2, int n3, int n4, float *pOrig, float *pNew);
...
void addImage(float *imgAcc, float *img, int n, float weight);
void calcObliqueParams(int maxTheta, float sDist, float zEdge, float sv, 
        float *cosTheta, float *tanTheta, int *skipSlices, float *dz1, float *dz2);
unsigned int findTofWeightRowIndex(float dist, int nDist, float wtStep);
void calcThetaAngleParams(int maxTheta, float sDist, float zEdge, float sv, 
        float *cosTheta, float *tanTheta, int nDist, float wtStep, 
        unsigned short nonZeroTofBins, float *tofWeights, unsigned short *tofSkips,
        DD_PARAMS *ddParams, float *thetaTofMap);
