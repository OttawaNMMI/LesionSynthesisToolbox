...
localDB = 'C:\Users\hjuma\Documents\LesionClassificationMLProject\GE710_Local_DB'; 
...
if 1
    [ConsoleDataList] = getConsoleDataList(ftpobj,consoleDB);
else 
    load('GE710_Console_Data_List.mat')
end 
...
function [ConsoleDataList] = getConsoleDataList(ftpobj,consoleDB)
...
% Locate a single RPDC/CTAC file
% Read DICOM Header
% Populate FTP File List

 ConsoleDataList = [dFolder', IDs', Names', Date'];

 name = ['GE710_Console_Data_List']; 
